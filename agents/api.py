"""
FastAPI REST API Server for Agent Rate Limit Backoff Governor.
"""
...
app = FastAPI(
    title="Agent Rate Limit Backoff Governor API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "agent-rate-limit-backoff-governor", "domain": "Long-Horizon Agent Context & State Architecture", "standard": "Autonomous Agent State Machine & Token Economy RFC", "version": "3.0.0-ENTERPRISE"}
