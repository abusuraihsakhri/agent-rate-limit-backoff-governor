"""
Data Models & Telemetry Definitions for RateLimit-Governor: Token-Bucket & Exponential Jitter Backoff Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Token Bucket & Full Jitter Backoff RFC"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
